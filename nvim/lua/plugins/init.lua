...
return merge_plugins(
	...
	require("plugins.navigation"), -- Navigation: snacks, telescope, oil, flash, hbac
	...
	require("plugins.ai"), -- AI: claudecode
	require("plugins.completion"), -- Completion: nvim-cmp
	require("plugins.lang") -- Language: crates, rustaceanvim, marp, markdown
)
